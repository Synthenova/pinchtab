...
const (
	...
	ActionHumanDoubleClick = "humanDoubleClick"
	ActionHumanDrag        = "humanDrag"
	ActionHumanHover       = "humanHover"
	ActionHumanScroll      = "humanScroll"
...
func (b *Bridge) InitActionRegistry() {
	b.Actions = map[string]ActionFunc{
		...
		ActionHumanDoubleClick: b.actionHumanDoubleClick,
		ActionHumanDrag:        b.actionHumanDrag,
		ActionHumanHover:       b.actionHumanHover,
		ActionHumanScroll:      b.actionHumanScroll,
